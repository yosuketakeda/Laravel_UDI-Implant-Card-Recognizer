            ...
            <tbody>
                <tr>
                    <td class="px-0">
                        ...
                        -->
                        <p class="seller">
                            <strong>{{ $invoice->buyer->companyRepresentative }}</strong>
                        </p>
                        <p class="seller">
                            Company : {{ $invoice->buyer->companyName }}
                        </p>
                        <p class="seller">
                            Phone Number : {{ $invoice->buyer->companyPhoneNumber }}
                        </p>
                        <p class="seller">
                            Email Address : {{ $invoice->buyer->companyEmailAddress }}
                        </p>
                        <p class="seller">
                            Address : {{ $invoice->buyer->companyAddress }}
                        </p>
                    ...
                    <td class="px-0">
                        ...
                        @if($invoice->buyer->healthInstitution)
                            <p class="buyer">
                                Health Institution : {{ $invoice->buyer->healthInstitution }}
                            </p>
                        @endif

                        @if($invoice->buyer->healthAddress)
                            <p class="buyer">
                                Health Address : {{ $invoice->buyer->healthAddress }}
                            </p>
                        @endif

                        @if($invoice->buyer->caseNumber)
                            <p class="buyer">
                                Case ID : {{ $invoice->buyer->caseNumber }}
                            </p>
                        @endif
                        
                        @if($invoice->buyer->date)
                            <p class="buyer">
                                Date : {{ $invoice->buyer->date }}
                            </p>
                        @endif

                        @if($invoice->buyer->surgeon)
                            <p class="buyer">
                                Surgeon : {{ $invoice->buyer->surgeon }}
                            </p>
                        @endif

                        @if($invoice->buyer->procedure)
                            <p class="buyer">
                                Procedure : {{ $invoice->buyer->procedure }}
                            </p>
                        @endif
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="border-0 pl-0">Catalog Number</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="pl-0">{{ $item->itemName }}</td>
                    
                    <td class="pl-0">{{ $item->catalogNumber}}</td>
